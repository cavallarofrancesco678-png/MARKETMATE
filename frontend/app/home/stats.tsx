...
function StatsScreenInner() {
  ...
  // Round 76 — RIMOSSO state weatherStats (era della card "METEO MEDIO PER MERCATO"
  // che l'utente ha richiesto di rimuovere). Le temperature sono ora visibili
  // solo nel MeteoStatsModal.
  ...
  /* Round 76 — RIMOSSE `marketsPeriodo`, `fetchWeatherStats` e auto-fetch effect
     della card "METEO MEDIO PER MERCATO" su richiesta utente. Le temperature
     restano accessibili dal MeteoStatsModal. */
  ...
  return (
    <View style={st.root}>
      ...
      <ScrollView contentContainerStyle={[st.scroll, { gap: GAP }]} showsVerticalScrollIndicator={false}>
        ...
        {/* ═══ ROUND 76 — RIMOSSA card "METEO MEDIO PER MERCATO" ═══
            L'utente l'ha segnalata come ridondante: le temperature sono già
            disponibili nel MeteoStatsModal (sotto ogni icona meteo nelle viste
            Settimana/Mese e nella colonna "°C med" della vista Anno). */}
