...
export interface TutorialStep {
  ...
  // ID dell'elemento (testID) verso cui puntare il fumetto (auto-scroll + freccia)
  anchorId?: string;
  // Direzione preferita per la freccia: 'top' = bubble sopra l'elemento (freccia in basso)
  // 'bottom' = bubble sotto (freccia in alto). 'auto' lascia decidere alla logica.
  arrowSide?: 'top' | 'bottom' | 'auto';
...
export const TUTORIAL_STEPS: TutorialStep[] = [
  ...
  { id: 'collab_setup', tKey: 'tutorial.steps.collab_setup', type: 'info', icon: 'account-group', route: '/home/settings', anchorId: 'sett-collab-card' },

  // 5. Agenda Mercati (in Settings, scroll a Mercati)
  { id: 'agenda_setup', tKey: 'tutorial.steps.agenda_setup', type: 'info', icon: 'calendar-week', route: '/home/settings', anchorId: 'sett-agenda-card' },

  // 6. Fornitori (in Settings, scroll a Fornitori)
  { id: 'fornitori_setup', tKey: 'tutorial.steps.fornitori_setup', type: 'info', icon: 'truck-delivery', route: '/home/settings', anchorId: 'sett-fornitori-card' },

  // 7. Spese fisse (in Settings, scroll a Spese annue)
  { id: 'spese_fisse_setup', tKey: 'tutorial.steps.spese_fisse_setup', type: 'info', icon: 'cash-multiple', route: '/home/settings', anchorId: 'sett-spese-card' },

  // 8. HOME!
  { id: 'home_calendar', tKey: 'tutorial.steps.home_calendar', type: 'info', icon: 'home', route: '/home', anchorId: 'home-date-row' },

  // 9. Meteo del giorno
  { id: 'home_lordo', tKey: 'tutorial.steps.home_lordo', type: 'info', icon: 'weather-sunny', route: '/home', anchorId: 'home-meteo-row' },

  // 10. Quanto hai incassato
  { id: 'home_incasso', tKey: 'tutorial.steps.home_incasso', type: 'info', icon: 'cash', route: '/home', anchorId: 'home-incasso-row' },

  // 11. Spese Extra
  { id: 'spese_extra_voci', tKey: 'tutorial.steps.spese_extra_voci', type: 'info', icon: 'cart-variant', route: '/home', anchorId: 'home-spese-row' },

  // 12. AI «Buongiorno»
  { id: 'buongiorno', tKey: 'tutorial.steps.buongiorno', type: 'info', icon: 'robot-happy', route: '/home', anchorId: 'home-buongiorno-btn' },

  // 13. Riquadro statistiche in basso
  { id: 'home_stats_box', tKey: 'tutorial.steps.home_stats_box', type: 'info', icon: 'view-dashboard', route: '/home', anchorId: 'home-stats-box' },

  // 14. Salva la giornata
  { id: 'home_salva', tKey: 'tutorial.steps.home_salva', type: 'info', icon: 'content-save-check', route: '/home', anchorId: 'home-salva-btn' },
  ...
  { id: 'carburante_setup', tKey: 'tutorial.steps.carburante_setup', type: 'info', icon: 'gas-station', route: '/home/gas', anchorId: 'gas-input-block' },
