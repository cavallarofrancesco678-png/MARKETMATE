 ...
 *
 * Dati di test per l'app.
 * ⚠️ TEMPORANEO: questo file verrà rimosso quando l'utente lo chiederà.
 *
 * Caricato automaticamente al primo avvio dopo il freshInstallWipe.
 * Il PIN preimpostato è "000000" (l'utente può cambiarlo da Riconfigura).
 */
